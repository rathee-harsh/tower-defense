...
class Bomber(game: Game, startLevel: Int = 1, startLocation: GridPos, val directionFacing: Direction, waitBetweenShots: Int) extends Tower(CANNON_IMAGE_PATH, game, startLevel, startLocation, waitBetweenShots):
  def action(): Unit =
